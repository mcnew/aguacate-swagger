...
RUN curl -sSL -o $CATALINA_HOME/webapps/ROOT.war https://repo1.maven.org/maven2/net/sf/aguacate/swagger/aguacate-swagger/0.1.10/aguacate-swagger-0.1.10.war \
 && echo "ead5f3de87d1beea1e493e8e9714510c35eab807  $CATALINA_HOME/webapps/ROOT.war" | sha1sum -c - \
