...
RUN curl -sSL -o $CATALINA_HOME/webapps/ROOT.war https://repo1.maven.org/maven2/net/sf/aguacate/swagger/aguacate-swagger/0.1.13/aguacate-swagger-0.1.13.war \
 && echo "17dc224836aea1d8b5b162160091e87201d2a064  $CATALINA_HOME/webapps/ROOT.war" | sha1sum -c - \
