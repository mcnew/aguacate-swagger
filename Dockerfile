...
RUN curl -sSL -o $CATALINA_HOME/webapps/ROOT.war https://repo1.maven.org/maven2/net/sf/aguacate/swagger/aguacate-swagger/0.1.14/aguacate-swagger-0.1.14.war \
 && echo "ad5919efbb95dfaaafbdf8e9058d40aebed12d9a  $CATALINA_HOME/webapps/ROOT.war" | sha1sum -c - \
